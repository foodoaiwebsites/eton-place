      ...
      <div className="z-40 flex flex-col gap-2">
        ...
        >
          ...
          <div className="flex flex-col gap-5">
            <p className="max-w-[400px] text-center font-inter text-sm font-[400] text-[#C1B6A6] md:text-start md:text-base">
            ...
            <h6
              className="hidden text-start font-oswald text-4xl font-[400] uppercase text-[#C1B6A6] md:block md:text-4xl"
              // style={{
              //   background:
              //     "linear-gradient(180deg, #CCAD64 29.5%, #191616 100%)",
              //   WebkitBackgroundClip: "text",
